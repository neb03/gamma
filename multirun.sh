...
do
    ...
    do
        ...
        python main.py --fitness1 latency --fitness2 energy --epochs $epochs \
                    --num_pe -1 --l1_size $l1_size --l2_size $l2_size --NocBW $noc_bw --offchipBW $offchip_bw --pe_limit $dig_pe \
        ...
        do
            ...
            do
                ...
                python main.py --fitness1 latency --fitness2 energy --epochs $epochs \
                            --num_pe -1 --l1_size $l1_size --l2_size $l2_size --NocBW $noc_bw --offchipBW $offchip_bw --pe_limit $cim_pe \
                            --model $cim_model_file --log_level $log_level --use_cim --subarray_size 32 --cim_stats_file $cim_file
            done
        done
    done
done
